...
<tr><th>Product ID</th><th>Image</th><th>Name</th><th>Price</th><th>
	...
	<a class=" btn btn-primary" href="jewellery_pdf.php" target="_blank">Download Horror PDF</a>
</th></tr>
<?php 

$result=mysqli_query($connection,"select product_id,image, product_name,price from products  where product_type like '%horror%' order by rand()")or die ("query 1 incorrect.....");
