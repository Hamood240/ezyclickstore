...
//Headings and logo
$pdf->Image('jewel.png',140,1,30);
$pdf->SetFont('Arial','',10);
$pdf->Cell(80,10,'Jewellery List',1,0,'C');
$pdf->Ln(20);
...
$query=mysqli_query($con,"select product_id, product_name, details, price from products where product_type like '%dress%'");
