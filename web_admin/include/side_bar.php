...
<!--<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='#'"><span class="glyphicon glyphicon-edit pull-left"></span> Customers </button></li>-->
  ...
  <ul class="dropdown-menu" style="width:240px">
    <li><a href="history_liist.php"><strong>history</strong> </a></li>
 <li><a href="horror_list.php"><strong> horror</strong></a></li>
 <li><a href="fiction_list.php"><strong> fiction</strong></a></li>
 <li><a href="thrill_list.php"><strong> thrill</strong></a></li>
   </ul></li>
