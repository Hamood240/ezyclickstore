...
<body>
  <?php include("include2/header.php");?>
	...
	<h1>History / Page <?php echo $page;?> </h1></div><br>
...
<tr><th>Product ID</th><th>Image</th><th>Name</th><th>Price</th><th>
	...
	<a class=" btn btn-primary" href="jewellery_pdf.php" target="_blank">Download History PDF</a>
</th></tr>
<?php 

$result=mysqli_query($connection,"select product_id,image, product_name,price from products  where product_type like '%history%' order by rand()")or die ("query 1 incorrect.....");
