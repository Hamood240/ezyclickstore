...
<h2 class="title text-center">HORROR</h2>
	<?php 
$cosmetics=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products where product_type like '%horror%' order by rand()")or die("Query 1 is inncorrect..........");
