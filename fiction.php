...
<h2 class="title text-center">FICTION</h2>
	<?php 
$cosmetics=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products where product_type like '%fiction%' order by rand()")or die("Query 1 is inncorrect..........");
