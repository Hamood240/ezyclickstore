...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Home |BOOK Store Store</title>
...
<!-- <li data-target="#slider-carousel" data-slide-to="2" class="active"></li> -->
		...
		<div class="item">
		<div class="col-sm-6">
<h1><span>ONINE BOOK</span>-Store</h1>
<h2>Online Store</h2>
<p>Find Everything You Need at The Official Bookstore. Save on Textbooks Today. Shop The Best Deals On Course Materials. Choose New, Used, or Digital Textbooks.
</p>
<a href="cosmetics.php" class="btn btn-default get">Get it now
</a>
		</div>
		<div class="col-sm-6">
<img src="images/bg1.png" class="girl img-responsive" alt="">
		</div></div>
...
<h1><span>ONLINE BOOKS</span>-Store</h1>
<h2>BOOK SHOP </h2>
<p>High School, College, Trades & Certification Programs - All for Pennies on the Dollar. In-Stock and Ready to Ship Afforadable, Used Books Shipped Straight to Your Home</p>
<a href="jewellery.php" class="btn btn-default get">Get it now
</a>
		</div>
		<div class="col-sm-6">
<img src="images/bg2.png" class="girl img-responsive" alt="">
		</div>
		</div>
		</div>
...
<h4 class="panel-title"><a href="#">TYPE OF BOOKS</a></h4></div></div>
...
<li><a href="link_form.php?link=oriflame"><img src="images/up2.jpeg" style="width:200px"></a></li>
<li><a href="link_form.php?link=nishat"><img src="images/up1.jpg" style="width:200px"></a></li>
<li><a href="link_form.php?link=oriflame"><img src="images/up3.jpg" style="width:200px"></a></li>
<li><a href="link_form.php?link=nishat"><img src="images/up4.jpg" style="width:200px"></a></li>
<li><a href="link_form.php?link=nishat"><img src="images/up5.jpg" style="width:200px"></a></li>
<li><a href="link_form.php?link=nishat"><img src="images/up6.jpg" style="width:200px"></a></li>
...
<h2 class="title text-center">New Items</h2>
		<?php 
$cosmetics=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products  where tags like '%books%' order by rand()")or die("Query 1 is inncorrect..........");
...
?>
        ...
        <img style="width:100%" src="images/ban1.jpg">
        </div><!--/category-tab-->
	</div></div>			<br><br>	
