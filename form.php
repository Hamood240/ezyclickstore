...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Payment |EzyClick Store</title>
...
<body>
	...
	<section id="cart_items">
		...
		<div class="register-req">
				<p>Please fill your form carefully so that you get your Order correctly</p>
			</div><!--/register-req-->
   ...
   <input type="text" name="zip_code" placeholder="Zip / Postal Code *">
	<select name="country">
		...
		<option value="sudia">Sudia Arab</option>
                  	...
                  	<select name="pmethod" style="margin-top: 8px;">
		<option>-- Payment Method --</option>
        <option value="pakistan">Cash On Delivery</option>
	</select>          
</div>
						</div>
					</div>
