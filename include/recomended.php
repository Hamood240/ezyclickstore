<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
            ...
            <?php 
$recommended=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products where tags like '%books%' order by rand() LIMIT 0,4")or die("Query 1 is inncorrect..........");
